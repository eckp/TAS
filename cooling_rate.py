...
def write_cache_cr(cr_data=(sample_range, all_cooling_rates, means, modes, medians), location='cr_cache.p'):
...
# deprecated, now pickling the relevant objects for easy caching
